        ...
        <div className="bg-slate-900 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 mb-8 shadow-lg border-none">
                        <CardHeader>
                            <CardTitle className="text-2xl text-gray-300">Overview</CardTitle>
                ...
                <motion.div variants={fadeIn}>
                    <Accordion type="single" collapsible className="mb-8">
                        <AccordionItem value="data-collection" className="border-gray-200">
                            ...
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <h3 className="font-medium text-lg text-gray-300 mb-2">Information We Collect</h3>
                                        <p className="text-gray-400">We collect the following types of information:</p>
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300 mt-6 mb-2">Collection Methods</h3>
                                        <p className="text-gray-400">We collect information through:</p>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                        ...
                        <AccordionItem value="data-use" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Use of Data
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <p className="text-gray-400">We use the collected data for various purposes:</p>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                        ...
                        <AccordionItem value="data-sharing" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Data Sharing
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <p className="text-gray-400">We do not share your personal information with third parties except in the following circumstances:</p>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                        ...
                        <AccordionItem value="security" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Security
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <p className="text-gray-400">The security of your data is important to us, but no method of transmission over the Internet or electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your personal information, we cannot guarantee its absolute security.</p>
                                        <h3 className="font-medium text-lg text-gray-300 mt-6 mb-2">Our Security Measures Include:</h3>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                        ...
                        <AccordionItem value="your-rights" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Your Rights
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <p className="text-gray-400">Depending on your location, you may have certain rights regarding your personal information:</p>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                        ...
                        <AccordionItem value="cookies" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                            ...
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <p className="text-gray-400">We use cookies and similar tracking technologies to track activity on our service and hold certain information. Cookies are files with a small amount of data that may include an anonymous unique identifier.</p>
                                        <h3 className="font-medium text-lg text-gray-300 mt-6 mb-2">Types of Cookies We Use:</h3>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400">
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 mb-8 shadow-lg border-gray-200 border-t-4 border-t-blue-500">
                        <CardHeader>
                            <CardTitle className="text-2xl text-gray-300">Changes to This Policy</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-gray-400">
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 mb-8 shadow-lg border-gray-200">
                        <CardHeader>
