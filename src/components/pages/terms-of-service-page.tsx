        ...
        <div className="bg-slate-900 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            ...
            >
                <motion.div variants={fadeIn} className="text-center mb-12">
                    <h1 className="text-4xl font-extrabold tracking-tight text-gray-300 sm:text-5xl mb-4">
                        Terms of Service
                    </h1>
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 border-none mb-8 shadow-lg">
                        <CardHeader>
                            <CardTitle className="text-2xl text-gray-300">Introduction</CardTitle>
                        ...
                        <CardContent>
                            ...
                            <Alert className="mt-6 border-amber-200 bg-slate-700/50">
                                <AlertTriangle className="h-4 w-4 text-yellow-300" />
                                <AlertTitle className="text-yellow-300">Important Notice</AlertTitle>
                ...
                <motion.div variants={fadeIn}>
                    <Accordion type="single" collapsible className="mb-8">
                        <AccordionItem value="service-description" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Service Description
                            </AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="account-terms" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Account Terms
                            </AccordionTrigger>
                            <AccordionContent>
                        ...
                        <AccordionItem value="user-content" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                ...
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <div className="flex items-center mb-4">
                                            ...
                                            <h3 className="font-medium text-lg text-gray-300 ">You Retain Ownership</h3>
                                        </div>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Content Restrictions</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Monitoring and Enforcement</h3>
                                        <p className="text-gray-400 ">
                        ...
                        <AccordionItem value="limitations" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                            ...
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <h3 className="font-medium text-lg text-gray-300  mb-2">Service Limitations</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Disclaimers and Limitations of Liability</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <Alert className="mt-6 border-gray-200 bg-gray-300">
                        ...
                        <AccordionItem value="intellectual-property" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                            ...
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <h3 className="font-medium text-lg text-gray-300  mb-2">Our Intellectual Property</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Restrictions</h3>
                                        <p className="text-gray-400 ">
                                            You agree not to:
                                        </p>
                                        <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Feedback</h3>
                                        <p className="text-gray-400 ">
                        ...
                        <AccordionItem value="term-termination" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Term & Termination
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <h3 className="font-medium text-lg text-gray-300  mb-2">Term</h3>
                                        <p className="text-gray-400 ">
                                            These Terms shall remain in full force and effect while you use the Service or maintain an account with us.
                                        </p>

                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Termination by You</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Termination by Us</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Effect of Termination</h3>
                                        <p className="text-gray-400 ">
                        ...
                        <AccordionItem value="dispute-resolution" className="border-gray-200">
                            <AccordionTrigger className="text-xl text-gray-300 font-semibold">
                                Dispute Resolution
                            </AccordionTrigger>
                            <AccordionContent>
                                <Card className="bg-slate-800 border-none shadow-none">
                                    <CardContent className="pt-4">
                                        <h3 className="font-medium text-lg text-gray-300  mb-2">Governing Law</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Informal Resolution</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Arbitration</h3>
                                        <p className="text-gray-400 ">
                                        ...
                                        <h3 className="font-medium text-lg text-gray-300  mt-6 mb-2">Exceptions</h3>
                                        <p className="text-gray-400 ">
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 mb-8 shadow-lg border-gray-200 border-t-4 border-t-blue-500">
                        <CardHeader>
                            <CardTitle className="text-2xl text-gray-300">Changes to Terms</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-gray-400 ">
                ...
                <motion.div variants={fadeIn}>
                    <Card className="bg-slate-800 border-gray-200 mb-8 shadow-lg">
                        <CardHeader>
                            <CardTitle className="text-2xl text-gray-300">Contact Us</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p className="text-gray-400 ">
