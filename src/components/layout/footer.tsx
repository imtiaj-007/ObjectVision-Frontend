...
import { FaLinkedin, FaSquareXTwitter, FaInstagram, FaDiscord } from "react-icons/fa6";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid md:grid-cols-5 gap-8">
                    <div className="col-span-2">
                        ...
                        <div className="flex w-60 md:w-full mx-auto space-x-6">
                            ...
                            <Link target="_blank" rel="noopener noreferrer" href="https://discord.com/users/imtiaj007" className="text-gray-400 hover:text-white">
                                <FaDiscord size={28} />
                            </Link>
                        </div>
                    </div>
